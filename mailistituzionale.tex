...
\section{Alias}
Un email\index{Mail!Alias} è una mail di inoltro che viene aggiunta dall'amministratore ad un utente\footcite{Google2023d}. Tale mail non può essere condivisa ne è un account
Possiamo creare fino a trenta alias diversi per utente.
\begin{center}

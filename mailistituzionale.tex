...
disponibili delle mail alias~\footcite{Garante2007}\index{Mail!istituzionale!alias} che nascondono l'identità degli utenti 
che  hanno rapporti 
...
\section{Alias}
Un'email\index{Mail!alias} alias è una mail di inoltro che viene aggiunta dall'amministratore ad un utente\footcite{Google2023d} tramite console\index{Console!amministrazione!alias}. Tale mail non può essere condivisa con altri utenti ne è un account.

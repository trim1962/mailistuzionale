\begin{changelog}[author=JOHN DOE, sectioncmd=\chapter*]
	\begin{version}[v=1.9.9.7,
		date=2024-05-10]
		\added
		\item Aggiunto capitolo Gestione
		\fixed
		\item Bug fixes
	\end{version}
			\begin{version}[v=1.9.9.6,
		date=2024-05-10]
		\added
		\item Gestire link tramite QRcode
		\fixed
		\item Bug fixes
	\end{version}
				\begin{version}[v=1.9.9.5,
				date=2023-12-30]
				\added
				\item Ulteriore aggiunta  Microsoft 365 abbozzo
				\fixed
				\item Bug fixes
			\end{version}

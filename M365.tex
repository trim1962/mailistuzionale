...
L'introduzione di 365 porta a problemi di gestione e creazione ex novo di utenti e password\cite{Google2023i}\cite{Goldy2020}.
\section{Gruppi}
...
\section{Sicurezza}
La verifica in due fattori tramite  Microsoft Authenticator (MFA) è stata disabilitata\cite{Microsoft2023a} 
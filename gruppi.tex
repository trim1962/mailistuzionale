...
Esempio: il gruppo docenti del 1T1 è: \textbf{D1T12324}. La mail di questo gruppo è \printmail{d1t12324@iisperugia.net}. Le  modalità di accesso  sono elencate nella~\cref{tab:ImpAccessoGruppi}.
...
Esempio: il gruppo docenti del 1T1 è: \textbf{A1T12324}. La mail di questo gruppo è \printmail{a1t12324@iisperugia.net}. Le  regole di accesso per questo gruppo sono elencate nella~\cref{tab:ImpAccessoGruppi}.
...
\subsection{Piscille}
Il gruppo dei docenti di Piscille è \textbf{DPISCILLE}. La mail di questo gruppo è \printmail{dpiscille@iisperugia.net}. Le  regole di accesso per questo gruppo sono elencate nella~\cref{tab:ImpAccessoGruppi}. 

Il gruppo degli alunni di Piscille è \textbf{APISCILLE}. La mail di questo gruppo è \printmail{apiscille@iisperugia.net}. Le  regole di accesso per questo gruppo sono elencate nella~\cref{tab:ImpAccessoGruppi}. 
\subsection{Olmo}
Il gruppo dei docenti di Olmo è \textbf{DOLMO}. La mail di questo gruppo è \printmail{dolmo@iisperugia.net}. Le  regole di accesso per questo gruppo sono elencate nella~\cref{tab:ImpAccessoGruppi}. 

Il gruppo degli alunni di Olmo è \textbf{AOLMO}. La mail di questo gruppo è \printmail{aolmo@iisperugia.net}. Le  regole di accesso per questo gruppo sono elencate nella~\cref{tab:ImpAccessoGruppi}. 
\subsection{Madonna Alta}
Il gruppo dei docenti di Madonnaalta è \textbf{DMALTA}. La mail di questo gruppo è \printmail{dmalta@iisperugia.net}. Le  regole di accesso per questo gruppo sono elencate nella~\cref{tab:ImpAccessoGruppi}. 

Il gruppo degli alunni di Olmo è \textbf{AMALTA}. La mail di questo gruppo è \printmail{amalta@iisperugia.net}. Le  regole di accesso per questo gruppo sono elencate nella~\cref{tab:ImpAccessoGruppi}. 
...
Fanno parte di questo gruppo i membri delle segreterie della scuola. Il gruppo è un gruppo nidificato\index{Gruppo!nidificato}. Le  regole di accesso di questo gruppo sono elencate nella~\cref{tab:ImpAccessoGruppi}
%\begin{center}
%	\begin{tabular}{p{3.2cm}p{1.5cm}p{1.5cm}p{1.5cm}p{1.5cm}p{1.5cm}}%{lccccc}
%		\bottomrule
%		Impostazioni di accesso	& Proprietari del Gruppo &  Gestore del Gruppo &
